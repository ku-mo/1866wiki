...
- announce absences clearly in `#nap-council-chat`
...
- `#case-log` — active cases and status changes  
- `#nap-votes` — vote announcements and results  
- `#nap-council-chat` — Council discussion and questions  
- `#nap-announcements` — final rulings, sanctions, and amendments  
- `#nap-proposals` — amendment proposals and discussion  
- `#evidence` — evidence (read-only for Council; posting is for reporters)
...
1. Notify Clerks in `#nap-council-chat` and, if necessary, ping them.  
2. Provide timestamped, valid evidence in `#evidence`.  
3. Request an **8-hour Emergency Vote** when appropriate.  
4. Once the emergency vote opens, coordinate with your alliance to follow any ceasefire, stand-down, or restitution directives that pass.
...
- Avoid backchannel lobbying. If a point matters, state it once in `#nap-council-chat`.
