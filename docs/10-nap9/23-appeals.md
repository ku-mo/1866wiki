...
## Article I — Eligibility {#t11-art1}

### Section I — Appealable Penalties {#t11-art1-sec1}
...
### Section II — Non-Appealable Penalties {#t11-art1-sec2}
...
## Article II — Filing an Appeal {#t11-art2}

### Section I — Deadline {#t11-art2-sec1}
Appeals must be filed within **48 hours** of the penalty’s issuance.

### Section II — Filing Location {#t11-art2-sec2}
All appeals must be posted to:

`NAP Discord → #appeals`

### Section III — Required Content {#t11-art2-sec3}
...
### Section IV — Rejection Conditions {#t11-art2-sec4}
...
## Article III — Intake & Validation {#t11-art3}

### Section I — Clerk Responsibilities {#t11-art3-sec1}
Clerks shall:
...
### Section II — Invalid Appeals {#t11-art3-sec2}
Appeals that fail validation after the correction window are dismissed.

---

## Article IV — Investigative Review {#t11-art4}

### Section I — Review Requirements {#t11-art4-sec1}
...
### Section II — Summary Report {#t11-art4-sec2}
...
## Article V — Council Vote {#t11-art5}

### Section I — Vote Window {#t11-art5-sec1}
A **24-hour Long Vote** opens immediately after the summary is posted.

### Section II — Voting Options {#t11-art5-sec2}
...
### Section III — Thresholds {#t11-art5-sec3}
- **Quorum:** 5 votes  
...
## Article VI — Restrictions During Appeal {#t11-art6}

### Section I — Enforcement Continuity {#t11-art6-sec1}
The offender must continue serving the penalty during the appeal process.

### Section II — No Interference {#t11-art6-sec2}
Alliances may not:
...
## Article VII — Finalization & Archival {#t11-art7}

### Section I — Clerk Actions {#t11-art7-sec1}
Clerks:
...
## Article VIII — Limits {#t11-art8}

### Section I — Filing Limits {#t11-art8-sec1}
...
### Section II — Procedural Limits {#t11-art8-sec2}
