...
### Section 2 — Voting Thresholds {#t6-art1-sec2}
...
### Section 3 — Vote Locking {#t6-art1-sec3}
...
## Article II — Vote Windows {#t6-art2}

### Section 1 — Standard Window Lengths {#t6-art2-sec1}
...
## Article III — Participation Enforcement {#t6-art3}

### Section 1 — Participation Standard {#t6-art3-sec1}
...
### Section 2 — Review Outcomes {#t6-art3-sec2}
...
### Section 3 — Reset Cycle {#t6-art3-sec3}
Participation counters reset every **14 days**.

---

## Article IV — Early Completion & Irregularities {#t6-art4}

### Section 1 — Quorum Timing {#t6-art4-sec1}
Meeting quorum early does **not** close the vote.  
Only early completion via all nine votes permits early certification.

### Section 2 — Vote Irregularities {#t6-art4-sec2}
...
### Section 3 — Authority to Vote {#t6-art4-sec3}
