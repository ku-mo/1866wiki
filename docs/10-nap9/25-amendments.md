...
## Article I — Authority to Propose {#t13-art1}

### Section I — Eligible Proposers {#t13-art1-sec1}
...
### Section II — Ineligible Parties {#t13-art1-sec2}
Individual players may not submit amendments directly; they must petition their R5 for sponsorship.

---

## Article II — Proposal Requirements {#t13-art2}

### Section I — Required Contents {#t13-art2-sec1}
...
### Section II — Clerk Validation {#t13-art2-sec2}
Missing or incomplete elements result in Clerk rejection and required resubmission.

---

## Article III — Notice & Posting {#t13-art3}

### Section I — Submission {#t13-art3-sec1}
Proposers must submit to:

`NAP Discord → #nap-proposals` and notify Clerks.

### Section II — Clerk Actions {#t13-art3-sec2}
Clerks:

1. Validate the proposal  
2. Assign an **Amendment ID** (A-YYMMDD-XX)  
3. Post to:  
   - `#nap-proposals` (discussion)  
   - `#nap-announcements` (read-only)

### Section III — Notice Period {#t13-art3-sec3}
A **24-hour Notice Period** is required before voting begins.  
Substantive edits **reset** the Notice Period.

---

## Article IV — Voting Procedure {#t13-art4}

### Section I — Vote Window {#t13-art4-sec1}
After Notice, Clerks open a **24-hour Long Vote**.

### Section II — Requirements {#t13-art4-sec2}
- **Quorum:** 5 votes  
...
## Article V — Activation & Conflict Handling {#t13-art5}

### Section I — Activation {#t13-art5-sec1}
Unless otherwise specified, amendments activate **immediately** upon passage.

### Section II — Conflicts {#t13-art5-sec2}
...
## Article VI — Failure & Reintroduction {#t13-art6}

### Section I — Waiting Period {#t13-art6-sec1}
A failed amendment may not be resubmitted for **7 days**.

### Section II — Substantial Revision Exception {#t13-art6-sec2}
If **two Clerks jointly certify** that the amendment has undergone substantial revision, it may be resubmitted immediately.

---

## Article VII — Emergency Amendments {#t13-art7}

### Section I — Invocation {#t13-art7-sec1}
...
### Section II — Procedure {#t13-art7-sec2}
- **1-hour Notice**  
- **8-hour Vote**  
- **Supermajority (7 YES)** required  

### Section III — Duration {#t13-art7-sec3}
Emergency amendments **expire in 30 days** unless passed again through the standard process.

---

## Article VIII — Conflicts of Interest {#t13-art8}

### Section I — Recusal {#t13-art8-sec1}
...
## Article IX — Archive Requirements {#t13-art9}

### Section I — Archive Contents {#t13-art9-sec1}
Clerks must store:
...
### Section II — Accessibility {#t13-art9-sec2}
Archives must remain accessible to all Full Member R5s.

---

## Article X — Workflow Summary (Non-Binding) {#t13-art10}

1. Proposal submitted → Clerk review  
2. Clerk validation → Amendment ID → 24h Notice  
3. 24h vote → **7 YES to pass**  
4. Activation per text → archives updated → superseded text retired
