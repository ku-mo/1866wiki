---
id: nap9-escalation
title: Title 8 — Escalation Logic
sidebar_label: Escalation
sidebar_position: 19
description: Framework governing how repeat behavior, evasion, tampering, and leadership failures escalate offense tiers or trigger alliance-level review.
slug: /nap9-escalation
---

# Title 8 — Escalation Logic {#t8}
...
## Article I — Escalation Framework {#t8-art1}

### Section 1 — Purpose {#t8-art1-sec1}
...
### Section 2 — Types of Escalation {#t8-art1-sec2}
...
## Article III — Pattern and Recurrence {#t8-art3}

### Section 1 — Recognition of Patterns {#t8-art3-sec1}
...
### Section 2 — Time Windows {#t8-art3-sec2}
...
### Section 3 — Aggregation {#t8-art3-sec3}
...
## Article IV — Evasion and Tampering {#t8-art4}

### Section 1 — Evasion {#t8-art4-sec1}
...
### Section 2 — Evidence Tampering {#t8-art4-sec2}
...
## Article V — Alliance-Level Review {#t8-art5}

### Section 1 — Purpose {#t8-art5-sec1}
...
### Section 2 — Triggers {#t8-art5-sec2}
...
### Section 3 — Council Authority {#t8-art5-sec3}
The Council may:
...
## Article VI — Procedural Responsibilities {#t8-art6}

### Section 1 — Alliance Responsibilities {#t8-art6-sec1}
Alliances must:
...
### Section 2 — Clerk Responsibilities {#t8-art6-sec2}
Clerks must:
...
### Section 3 — Council Responsibilities {#t8-art6-sec3}
The Council:
